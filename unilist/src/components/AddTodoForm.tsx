      ...
      <form onSubmit={handleSubmit}>
        <div className="flex">
          <input
            ...
            className="flex-1 bg-transparent text-white placeholder-pink-200 focus:outline-none"
          />
          <button
            type="submit"
        ...
        {isExpanded && (
          <div className="mt-3">
            <textarea
              ...
              className="w-full bg-white bg-opacity-20 rounded-lg px-3 py-2 text-white placeholder-pink-200 focus:outline-none focus:ring-2 focus:ring-pink-300 mt-2"
              rows={2}
            />
          </div>
        )}
        ...
        <div className="mt-2 flex justify-between">
          {!isExpanded && (
            <button
              ...
              className="text-pink-200 text-sm hover:text-white transition"
            >
              Add description
            </button>
          )}
